...
export default function AboutContactSection() {
    ...
    return (
        <section className='relative pt-32 pb-20 bg-[#001F3F] font-["Plus_Jakarta_Sans"] overflow-hidden text-white'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-20 items-start'>
                    ...
                    <div className='lg:col-span-7 flex flex-col space-y-12'>
                        <div>
                            ...
                            <p className='text-white/60 text-xl leading-relaxed font-medium max-w-2xl'>
                                At EduConsultants, we believe every student deserves clear, honest, and professional guidance. We specialize in end-to-end support for <span className="text-white font-bold underline decoration-[#CE2029] underline-offset-4">MBBS Abroad</span>, European excellence, and premium local admissions.
                            </p>
                        </div>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                            <div className='group p-8 rounded-3xl bg-white/5 border border-white/10 transition-all hover:bg-white/10'>
                                ...
                                <h4 className='font-black text-xl tracking-tight mb-2'>Student-First</h4>
                                <p className='text-white/40 text-sm font-medium'>Every plan is meticulously tailored to your academic and financial parameters.</p>
                            </div>
                            <div className='group p-8 rounded-3xl bg-white/5 border border-white/10 transition-all hover:bg-white/10'>
                                <GlobeIcon className='size-8 text-[#00E0FF] mb-4' />
                                <h4 className='font-black text-xl tracking-tight mb-2'>Direct Access</h4>
                                <p className='text-white/40 text-sm font-medium'>No middlemen. Direct university communication protocols and transparent fee structures.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='lg:col-span-5'>
                        <div className='bg-white rounded-[3rem] p-10 md:p-14 text-[#001F3F] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] relative overflow-hidden'>
                            ...
                            <h3 className='text-3xl font-black tracking-tight mb-12'>Get in Touch</h3>
                            ...
                            <div className='space-y-10 relative z-10'>
                                <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className='flex items-center gap-6 group'>
                                    ...
                                    <div>
                                        <p className='text-slate-400 text-[10px] font-black uppercase tracking-widest mb-1'>Immediate Help</p>
                                        <p className='text-xl font-bold tracking-tight'>Chat on WhatsApp</p>
                                    </div>
                                </a>
                                ...
                                <div className='flex items-center gap-6 group'>
                                    ...
                                    <div>
                                        <p className='text-slate-400 text-[10px] font-black uppercase tracking-widest mb-1'>Email Support</p>
                                        <p className='text-xl font-bold tracking-tight'>admissions@edu.com</p>
                                    </div>
                                </div>
                                ...
                                <div className='flex items-center gap-6 group'>
                                    ...
                                    <div>
                                        <p className='text-slate-400 text-[10px] font-black uppercase tracking-widest mb-1'>Direct Line</p>
                                        <p className='text-xl font-bold tracking-tight'>+91 80153 59971</p>
                                    </div>
                                </div>
                            </div>
