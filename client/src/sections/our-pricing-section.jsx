        ...
        <section className='relative py-24 bg-[#FDFDFD] font-["Plus_Jakarta_Sans"] overflow-hidden'>
            ...
            <div className="container mx-auto px-6 md:px-16 lg:px-24">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8">
                    ...
                    <button className='hidden lg:flex items-center gap-3 text-sm font-black text-[#001F3F] hover:text-[#CE2029] transition-colors group'>
                ...
                <div className='mt-16 flex justify-center lg:hidden'>
                    <button className='w-full rounded-2xl bg-[#001F3F] py-5 text-sm font-black text-white shadow-xl shadow-[#001F3F]/20'>
                        BROWSE ALL RESOURCES
                    </button>
                </div>
            </div>
